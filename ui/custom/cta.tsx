...
export default function CTA() {
  return (
        ...
        <section className="mt-16 py-14 px-24">
            ...
            <div className="grid gap-6 md:grid-cols-2 md:items-center">
              <div>
                ...
                <p className="mt-2 max-w-prose text-slate-300">
                  Tell me your goal—no-code, low-code, or custom—and I’ll
                  propose the fastest, cleanest path.
                </p>
              </div>
              <div className="flex flex-wrap gap-3 md:justify-end">
                <Link
                  href="/contact"
                  className="inline-flex items-center rounded-xl bg-brand-blue px-5 py-3 font-medium text-white transition hover:bg-brand-blue-deep"
                >
                  Book a call
                </Link>
                <Link
